...
export const textList = [
  ...
  <p key="paragraph5" className="my-4 font-serif text-xl z-10">
  ...
  <p key="paragraph6" className="my-4 font-serif text-xl z-10">
  ...
  <p key="paragraph7" className="my-4 font-serif text-xl z-10">
  ...
  <p key="paragraph8" className="my-4 font-serif text-xl z-10">
  ...
  <p key="paragraph9" className="my-4 font-serif text-xl z-10">
  ...
  <p key="paragraph10" className="my-4 font-serif text-xl z-10">
...
export const textList2 = [
  ...
  <p key="paragraph5" className="font-zyzolText my-4 z-10 text-xl">
  ...
  <p key="paragraph6" className="font-zyzolText my-4 z-10 text-xl">
